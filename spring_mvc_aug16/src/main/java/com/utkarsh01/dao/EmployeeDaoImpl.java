...
public class EmployeeDaoImpl extends JdbcDaoSupport implements EmployeeDao {
	...
	private String ADD="insert into employeedata(empId,name,dept,salary) values(?,?,?,?)";
	...
	public void addEmp(EmployeeDetails emp) {
		getJdbcTemplate().update(ADD,emp.getEmpId(), emp.getName(),emp.getDept(),emp.getSalary());
	}
