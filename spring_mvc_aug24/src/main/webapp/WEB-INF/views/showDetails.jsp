...
<body>
	<div class="container">
		...
		<a href="addEmp"><button class="btn btn-outline-success">Add New Employee</button></a>
			...
			<table class="table table-striped-columns">
				...
				<tbody>
					...
					<tr>
						...
						<td><%=emp.getDept()%></td>
						<td><%=emp.getSalary()%></td>
						<td><input type="button" value="Edit" class="btn btn-outline-primary"
							onclick="editButton('<%=emp.getEmpId()%>')" /></td>
						<td><input type="button" value="Delete" class="btn btn-outline-danger"
