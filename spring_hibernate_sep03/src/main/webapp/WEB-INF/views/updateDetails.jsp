...
<body>
	...
	<frm:form action="updateEmp" method="post"
		class="container d-flex mt-3 form-control " modelAttribute="employeeDetails">
		<div class="w-25 mx-auto border p-3">
			...
			<div class="form-floating mt-3">
				...
				<frm:errors path="salary" cssClass="error" />
			</div>
			<div class=" d-flex justify-content-around mt-3">
				<div class="form-floating ">
					<input type="submit"
						class="text-center btn btn-outline-warning form-label" value="Update">
				</div>

				<div class="form-floating ">
					<a href="showEmp"><input type="button"
						class="text-center btn btn-outline-danger form-label"
						value="Cancel"> </a>
				</div>
			</div>
		</div>
